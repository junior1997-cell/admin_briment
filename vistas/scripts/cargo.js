...
function listar_cargo() {
  ...
  tabla_cargos=$('#tabla-cargo').dataTable({
    ...
    buttons: [
      { text: '<i class="fa-solid fa-arrows-rotate" data-toggle="tooltip" data-original-title="Recargar"></i> ', className: "btn bg-gradient-info", action: function ( e, dt, node, config ) { tabla_cargos.ajax.reload(); toastr_success('Exito!!', 'Actualizando tabla', 400); } },
