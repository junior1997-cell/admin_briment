...
Class presentacion
{
	...
	public function insertar($nombre,$descripcion)
	{
		...
		$sql_bit = "INSERT INTO bitacora_bd( nombre_tabla, id_tabla, accion, id_user) VALUES ('presentacion','".$intertar['data']."','Nueva presentación registrada','$this->id_usr_sesion')";
	...
	public function editar($idpresentacion,$nombre,$descripcion)
	{
		...
		//add registro en nuestra bitacora
		$sql_bit = "INSERT INTO bitacora_bd( nombre_tabla, id_tabla, accion, id_user) VALUES ('presentacion','$idpresentacion','Presentación editada','$this->id_usr_sesion')";
		$bitacora = ejecutarConsulta($sql_bit); if ( $bitacora['status'] == false) {return $bitacora; }  
	...
	{
		$sql="UPDATE presentacion SET estado='0',user_trash= '$this->id_usr_sesion' WHERE idpresentacion='$idpresentacion'";
		$desactivar= ejecutarConsulta($sql);

		if ($desactivar['status'] == false) {  return $desactivar; }
		
		//add registro en nuestra bitacora
		$sql_bit = "INSERT INTO bitacora_bd( nombre_tabla, id_tabla, accion, id_user) VALUES ('presentacion','".$idpresentacion."','Presentación desactivada','$this->id_usr_sesion')";
		$bitacora = ejecutarConsulta($sql_bit); if ( $bitacora['status'] == false) {return $bitacora; }   
	...
	{
		$sql="UPDATE presentacion SET estado_delete='0',user_delete= '$this->id_usr_sesion' WHERE idpresentacion='$idpresentacion'";
		$eliminar =  ejecutarConsulta($sql);
		if ( $eliminar['status'] == false) {return $eliminar; }  
		
		//add registro en nuestra bitacora
		$sql = "INSERT INTO bitacora_bd( nombre_tabla, id_tabla, accion, id_user) VALUES ('presentacion','$idpresentacion','Presentación Eliminado','$this->id_usr_sesion')";
